...
¡Gracias por tu interés en contribuir a **AuthApp CI**! Esta guía describe el flujo de trabajo, los estándares de código y el proceso de Pull Requests.
...
- Sigue las convenciones idiomáticas de Java: `camelCase` para métodos y variables, `PascalCase` para clases, `UPPER_SNAKE_CASE` para constantes.
...
- Ejecuta la suite completa antes de abrir el PR (mvn clean test).
